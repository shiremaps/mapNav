define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        zoomIn: function() {
            this.map.setMapCursor("url('js/gis/Widgets/NavTools/images/zoomin.cur'),auto");
            this.disconnectMapClick();
            this.navTools.activate(Navigation.ZOOM_IN);
        },
        zoomOut: function() {
            this.map.setMapCursor("url('js/gis/Widgets/NavTools/images/zoomout.cur'),auto");  //js/gis/Widget/NavTools/images/zoomin.cur
        ...
        pan: function () {
            this.map.setMapCursor("url('js/gis/Widgets/NavTools/images/hand.cur'),auto");
